...
namespace MARS_AdvanceTask.ProfilePage
{
    ...
    public class ManageShareSkill
    {
        ...
        {
            ExcelHelper.PopulateInCollection(@"C:\Users\Pinal\Desktop\MVPstudio Intenship\Advance Task\MARS AdvanceTask\Data\ExcelData1.xlsx", "ShareSkill");
            ...
            StartDateDropDown.SendKeys("21/08/2022");
            Thread.Sleep(1000);

            //Select End Date
            EndDateDropDown.Click();
            EndDateDropDown.SendKeys("27/08/2022");
            Thread.Sleep(1000);
            ...
            for (int i = 0; i < Days.Count(); i++)
            {
                ...
                if (value.Equals("1") && svalue.Equals("1") && evalue.Equals("1"))
                {
                    ...
                    Start_time.Click();
                    Thread.Sleep(1000);
                    Start_time.SendKeys("08:00");
                    Thread.Sleep(1500);

                    End_time.Click();
                    Thread.Sleep(1000);
                    End_time.SendKeys("14:00"); 
                    Thread.Sleep(1500);
            ...
            Thread.Sleep(1000);
            autoIT.Send(@"C:\Users\Pinal\Desktop\MVPstudio Intenship\Advance Task\MARS AdvanceTask\Workattchment.jpg");
            Thread.Sleep(1000);
            autoIT.Send("{Enter}");
            Thread.Sleep(1000);
        ...
        public void EditShareSkill(IWebDriver driver)
        {
            ...
            autoIT.Send(@"C:\Users\Pinal\Desktop\MVPstudio Intenship\Advance Task\MARS AdvanceTask\logoDesign.jpg");
            Thread.Sleep(2000);
            autoIT.Send("{Enter}");
            Thread.Sleep(2000);

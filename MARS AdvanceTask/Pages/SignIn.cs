...
namespace MARS_AdvanceTask.Pages
{
    public class SignInpage
    {
        ...
        public void addlogindetail(IWebDriver driver)
        {
            ...
            SignInbtn.Click();
            Thread.Sleep(2000);
            ExcelHelper.PopulateInCollection(@"C:\Users\Pinal\Desktop\MVPstudio Intenship\Advance Task\MARS AdvanceTask\Data\ExcelData1.xlsx", "SignIn");
            Emailtxtbox.Click();
            Emailtxtbox.Clear();
